...
@section('content')
    ...
    <div class="well">
        <div class="btn-group pull-right">
            <a style="width: 100px;" href="{{ route('yonetim.urun.yeni') }}" class="btn btn-primary">Yeni</a>
        </div>
                ...
                <td class="text-center">
                    <img src=" {{ $entry->detay->urun_resmi!=null ?
                            asset('/uploads/urunler/' . $entry->detay->urun_resmi) :
                             'http://via.placeholder.com/120x120?text=UrunResmi' }}" class="img-responsive" style="width: 120px">
                </td>
                <td>{{ $entry->slug }}</td>
