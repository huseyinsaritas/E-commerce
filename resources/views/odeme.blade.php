    ...
    <div class="bg-content">
        ...
        <div class="row">
            <div class="col-md-5">
                ...
                <div class="form-group">
                    <label for="son_kullanama_tarihi_ay">Son Kullanma Tarihi</label>
                    <div class="row">
                        <div class="col-md-6">
                            Ay
                            <select name="son_kullanama_tarihi_ay" id="son_kullanama_tarihi_ay" class="form-control" required>
                                <option>1</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            Yıl
                            <select id="son_kullanama_tarihi_yil" name="son_kullanama_tarihi_yil" class="form-control" required>
                                <option>2017</option>
                            </select>
                        </div>
                    </div>
